                    ...
                    builder: (context, state) {
                      switch (state.selectedTab) {
                        case CommunityTab.matches:
                          return ListView(
                            children: const [
                              MatchCard(format: "6v6", day: "Tonight", title: "Arena Pro Stadium", time: "8:00 PM", playersCount: "8/12", level: "Intermediate"),
                              MatchCard(format: "6v6", day: "Tomorrow", title: "Victory Ground", time: "6:00 PM", playersCount: "10/12", level: "Advanced"),
                              MatchCard(format: "6v6", day: "Apr 28", title: "Champions Field", time: "7:00 PM", playersCount: "6/12", level: "Beginner"),
                            ],
                          );
