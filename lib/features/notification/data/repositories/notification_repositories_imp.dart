...
class NotificationRepositoriesImp
  ...
  @override
  DataResponse<void> confirmExtra(int id) async =>
      wrapHandlingException(
        tryCall: () => _remoteData.confirmExtra(id),
      );

  @override
  DataResponse<void> rejectExtra(int id) async =>
      wrapHandlingException(
        tryCall: () => _remoteData.rejectExtra(id),
      );
}
